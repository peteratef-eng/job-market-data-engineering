...
cols = st.columns(3)
with cols[0]:
    section_card("Reliable Pipelines", "ETL workflows that move raw records into structured, trusted datasets.")
with cols[1]:
    section_card("Analytics-Ready Models", "Clean staging layers, reusable joins, and marts designed around business questions.")
with cols[2]:
    section_card("Quality Checks", "Validation for row counts, nulls, duplicates, joins, and calculation logic.")
